...
// STATIC VARIABLES
// the system
Parser* GLCanvasPS::parser = NULL;

// viewport & mouse
Vec3f GLCanvasPS::camera_pos = Vec3f(0, 0, 20);
int GLCanvasPS::width = 250;
int GLCanvasPS::height = 250;
int GLCanvasPS::mouse_button = -1;
int GLCanvasPS::mouse_x = 0;
int GLCanvasPS::mouse_y = 0;

// actions & rendering
int GLCanvasPS::paused = 0;
float GLCanvasPS::refresh = 100;
float GLCanvasPS::dt = 100;
int GLCanvasPS::integrator_color = 0;
int GLCanvasPS::draw_vectors = 0;
float GLCanvasPS::acceleration_scale = 0;
int GLCanvasPS::motion_blur = 0;
...
void GLCanvasPS::initialize(Parser* _parser, float _refresh, float _dt,
...
void GLCanvasPS::reshape(int w, int h) {
...
void GLCanvasPS::mouse(int button, int state, int x, int y) {
...
void GLCanvasPS::motion(int x, int y) {
...
void GLCanvasPS::keyboard(unsigned char key, int x, int y) {
    switch (key) {
    case 'p':  case 'P':
        if (paused == 0) {
...
void GLCanvasPS::idle(int value) {
